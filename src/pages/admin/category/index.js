                ...
                <main>
                    <div class="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
                        ...
                        <div class="px-4 py-6 sm:px-0">
                            <div class="bCategory-4 border-dashed border-gray-200 rounded-lg">
                                    ...
                                    ${data.map((item) => /* html */`
                                        <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap text-center text-sm font-medium">
                                                <a href="/#/admin/category/edit/${item.id}" class="text-white rounded-xl bg-blue-600 py-2 px-4 mr-2 hover:text-black hover:bg-red-600">Edit</a>
    ...
    afterRender() {
        ...
        btns.forEach((btn) => {
            btn.addEventListener("click", () => {
                ...
                if (confirm) {
                    remove(id)
                        .then(() => window.location.href = "/#/admin/category/index");
                }
            });
        });
    },
